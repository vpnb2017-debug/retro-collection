...
import { localFileSync } from './services/localFileSync.js?v=22';
    ...
    try {
        ...
        <div class="view-scroll">
            <div class="header-section">
                ...
                <p class="subtitle">Aqui está o resumo do teu império. <span style="opacity:0.3; font-size:0.7rem; font-weight:400;">v22</span></p>
                ${installNotice}
            </div>
        ...
        <div style="max-width: 500px; margin: 2rem auto;">
            <div class="glass" style="padding: 2rem; border-radius: var(--radius-lg); display:flex; flex-direction:column; gap:1.5rem;">
                <div style="text-align:center;">
                    ...
                    <p style="margin-top:0.5rem; color:var(--accent-secondary); font-weight:600;">Modo Sem API (v22)</p>
